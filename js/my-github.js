...
function getUserRepoList(user = "clems27") {
...
// // Write code here to communicate with Github
// fetch("https://api.github.com/users/clems27/repos")
// .then(response => {
//     return response.json();
// }).then(repos =>{
...
//     console.log(repos)
//     repos.forEach(repo => {
//         var parentEl = document.getElementById("repos-list");
//          var listEL = document.createElement("li");
//         listEL.innerHTML = "<a href = ' " + repo.html_url+"'>" + repo.name +"</a>";
